...
const GetStarted = () => {
  return (
    <div className="text-center xl:p-10 py-10">
      ...
      <h5 className="flex py-4 sm:text-base xs:text-sm text-[12px]"><Image src={blackdiamondicon} height={25} className="xl:h-full xs:h-1/2 h-[20px]"/><span className="px-5">Feel free to click on the hint, if you find it challenging.</span></h5>
